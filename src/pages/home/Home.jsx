  ...
  return (
    <div className='flex justify-center items-center flex-wrap phone:flex-nowrap bg-slate-100'>
      <div className="relative w-full lg:w-3/4 py-10 phone:py-4 phone:mb-10 pl-10 sm:pl-12 phone:px-8 pr-[60px] sm:pr-20 lg:px-8 xl:pl-20 bg-slate-100">
        <h3 className='uppercase font-sans text-2xl sm:text-3xl phone:text-lg lg:text-2xl xl:text-4xl 2xl:text-5xl text-slate-900 font-bold leading-8 sm:leading-10 phone:leading-6 2xl:leading-tight'>
          Hi There!
        </h3>
        <div className="flex mb-2 md:mb-4 xl:mb-0">
          <h2 className='font-sans font-bold text-3xl sm:text-4xl phone:text-xl lg:text-3xl xl:text-5xl 2xl:text-6xl text-slate-900 leading-8 sm:leading-10 phone:leading-6 2xl:leading-tight'>
            I'M
          </h2>
          <h1 className='uppercase font-cursive font-bold text-3xl sm:text-4xl phone:text-xl lg:text-3xl xl:text-5xl 2xl:text-6xl phone:ml-2 ml-4 xl:ml-6 leading-8 sm:leading-10 phone:leading-6 2xl:leading-tight text-yellow-500'>
            Serj Qazi
          </h1>
        </div>
        <h3 className='uppercase font-sans font-bold  text-sm phone:text-xs lg:text-sm xl:text-base 2xl:text-lg text-slate-900 bg-yellow-500 w-fit my-3 sm:my-4 phone:my-2 xl:my-3 xl:mb-4 px-2.5 py-0.5 sm:py-1'>
          Frontend Developer
        </h3>

        <div className="font-sans font-light text-xs sm:text-base phone:text-xs lg:text-sm xl:text-base 2xl:text-lg text-slate-900 mb-4 leading-5 sm:leading-6 phone:leading-4">
          <p>
