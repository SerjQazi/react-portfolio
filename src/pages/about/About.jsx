          ...
          <div className='my-4 md:mt-6 md:mb-4'>
            ...
            <div className='flex flex-row-reverse justify-between sm:flex-col mb-4 phone:mb-4 sm:mb-4'>
              ...
              <div className='text-slate-700 font-thin'>
                <div className="text-lg phone:text-lg sm:text-2xl mb-0 phone:mb-2 sm:mb-4 lg:mb-6 font-light tracking-wide leading-5 sm:flex justify-start items-center">
            ...
            <div className="flex flex-col-reverse phone:grid grid-cols-3 phone:grid-cols-4">
              ...
              <div className="col-span-2 phone:col-span-3 bg-slate-700 drop-shadow-lg">
                <Skills />              
              </div>
