...
const About = () => {
  ...
  return (
      <div className='flex justify-center bg-slate-100 phone:ml-2'>
        <div className="wrapper w-full lg:w-10/12 px-2 h-[90.01vh] phone:h-auto sm:px-4 phone:px-0 phone:pr-2 border-2 border-red-500">
          ...
          <div className='flex flex-row-reverse justify-between sm:flex-col mt-4 mb-2 phone:mb-2 sm:mb-4'>
            ...
            <div className='text-slate-700 font-thin'>
              <div className="text-lg phone:text-lg sm:text-2xl mb-2 phone:mb-2 sm:mb-4 lg:mb-6 font-light tracking-wide leading-5 sm:flex justify-start items-center">

                <h2 className='mb-1 phone:mb-0 phone:text-base'>
                  I'm <span className='font-black'>Serj Qazi,</span> 
                </h2>
                <h2 className='text-xs phone:text-base sm:text-xl font-thin underline underline-offset-4 sm:no-underline phone:ml-1 sm:ml-3'>
              ...
              : <p className='text-xs phone:text-[0.5rem] sm:text-sm lg:text-base tracking-wide phone:tracking-wide sm:tracking-widest ml-2 sm:ml-2 phone:leading-[1rem]'>
          ...
          <div className="flex flex-col-reverse phone:grid grid-cols-3 phone:grid-cols-4">
            ...
            <div className="text-slate-700 font-thin col-span-1 phone:pl-2 lg:pl-8">
              <h3 className='text-lg sm:text-base lg:text-2xl mb-2 phone:mb-3 font-bold'>
                What I Do?
              </h3>
              ...
              <div className="mb-3 phone:mb-6 ml-2 phone:ml-0 flex phone:items-center">
                ...
                <div className="w-2/3 phone:w-fit ml-6 phone:ml-2 text">
                  <h3 className='font-bold text-sm phone:text-[0.7rem] sm:text-base mb-1'>Development</h3>
              ...
              <div className="mb-4 ml-2 phone:ml-0 flex phone:items-center">
                ...
                <div className="w-2/3 phone:w-fit ml-6 phone:ml-2 text">
                  <h3 className='font-bold text-sm phone:text-[0.7rem] sm:text-base mb-1'>Figma Design</h3>
                  <p className='text-xs sm:text-sm phone:hidden lg:block'>
