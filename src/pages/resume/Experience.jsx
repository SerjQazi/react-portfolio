...
const Resume = () => {
  ...
  return (
    <div className=''>
      <h3 className='uppercase font-bold text-base phone:text-base sm:text-2xl lg:text-2xl xl:text-3xl text-slate-700 mb-2 phone:mb-1'>
        Experience
      </h3>
          ...
          <div className='text-slate-700 phone:grid grid-cols-2'>
            <div className='mb-3 phone:mb-0 phone:mr-2 lg:mr-6'>
              ...
              <p className='font-thin text-sm phone:text-xs mb-2 phone:mb-0.5 sm:text-lg lg:text-sm xl:text-base xl:mb-2'>
                ...
                <ul className='text-xs phone:text-[0.5rem] sm:text-base lg:text-xs xl:text-base lg:font-thin'>
                  <li className='ml-6 phone:ml-4 list-disc mb-1 phone:mb-0 phone:leading-3 xl:leading-5 lg:mb-2 xl:mb-1 mr-10'>
                  ...
                  <li className='ml-6 phone:ml-4 list-disc mb-1 phone:mb-0 phone:leading-3 xl:leading-5 lg:mb-2 xl:mb-1 lg:mr-10'>
