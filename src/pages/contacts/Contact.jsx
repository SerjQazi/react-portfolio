  ...
  return (
      <div className='flex justify-center items-center bg-slate-100'>
        ...
        <div className="lowerCont phone:flex flex-row-reverse justify-center items-start ">
          ...
          <div className='my-4 phone:my-1 sm:my-14 lg:my-2 xl:my-10 2xl:my-12 phone:mx-10 text-slate-700 sm:flex sm:flex-wrap sm:justify-evenly sm:items-center phone:flex-col phone:justify-center phone:items-start px-6 lg:px-0'>
            ...
            <div className="icon text-4xl phone:text-2xl sm:text-6xl lg:text-4xl xl:text-5xl mb-1 ml-14 sm:ml-0 sm:mb-4 phone:mb-0 lg:mb-2 xl:mb-5 flex phone:justify-start items-center">
              ...
              <div className="text-base phone:text-sm sm:text-lg lg:text-sm xl:text-lg ml-4 py-2 phone:py-3  sm:py-6 cursor-pointer hover:scale-110 duration-300 ease-in-out">
            ...
            <div className="icon text-4xl phone:text-2xl sm:text-6xl lg:text-4xl xl:text-5xl mb-1 ml-14 sm:ml-0 flex phone:justify-start items-center">
              <FaLinkedin />
              <div className='text-base phone:text-sm sm:text-lg lg:text-sm xl:text-lg  ml-4 py-2 phone:py-3 sm:py-6 cursor-pointer hover:scale-110 duration-300 ease-in-out'>
