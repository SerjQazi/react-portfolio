        ...
        <>
            ...
            <div className="navContainer phone:h-[52.5vh] lg:h-[42.5vh] 2xl:h-[44.4vh] bg-yellow-500 flex justify-center items-center">
                <ul className='uppercase font-sans font-bold text-[0.5rem] lg:text-sm xl:text-base 2xl:text-lg text-center tracking-[0.35em]'>
                    <li className='p-4 phone:p-2 lg:p-4 xl:p-6 mb-2 phone:my-2 border-b border-slate-900 border-opacity-25'>
                    ...
                    <li className='p-4 phone:p-2 lg:p-4 xl:p-6 mb-2 phone:my-2'>
