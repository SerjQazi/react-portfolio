  ...
  return (
    <div className='mainCardContainer flex justify-center items-center flex-wrap phone:flex-nowrap bg-slate-100'>
      ...
      <div className="leftSideContainer flex w-full lg:w-3/4">
        ...
        <div className="textContainer lg:pl-20 lg:pr-4">
          
          <div className='header uppercase font-sans font-black text-slate-700 mb-2 lg:mb-4'>
          ...
          <h3 className='tracking-wide uppercase font-bold  text-sm phone:text-xs lg:text-sm xl:text-base 2xl:text-lg text-slate-700 bg-yellow-500 w-fit mb-2 sm:mb-4 phone:mb-2 xl:mb-4 2xl:mb-6 px-2.5 py-0.5 sm:py-1'>
            Frontend Developer
          </h3>

          <div className="tracking-normal font-thin text-xs sm:text-base phone:text-xs lg:text-sm xl:text-base 2xl:text-lg 3xl:text-xl text-slate-700 mb-4 lg:mb-8 2xl:mb-10">
            <p>
